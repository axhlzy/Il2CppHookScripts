...
class mscorlib_System_Reflection_Module_impl extends mscorlib_System_Type_impl {
    ...
    static get ctor(): mscorlib_System_Object {
        return new mscorlib_System_Reflection_Module_impl(Il2cpp.Api.Module._ctor(alloc()))
    }

    static get _cctor(): mscorlib_System_Reflection_Module_impl {
        return new mscorlib_System_Reflection_Module_impl(Il2cpp.Api.Module._cctor(alloc()))
    }

    CreateNIE(): mscorlib_System_Exception {
        return Il2cpp.Api.Module._CreateNIE(this.handle)
    }

    Equals(other: NativePointer): boolean {
        return Il2cpp.Api.Module._Equals(this.handle, other)
    }

    filter_by_type_name(type: mscorlib_System_Type_impl, obj: NativePointer): boolean {
        return Il2cpp.Api.Module._filter_by_type_name(this.handle, type.handle, obj)
    }

    filter_by_type_name_ignore_case(type: mscorlib_System_Type_impl, obj: NativePointer): boolean {
        return Il2cpp.Api.Module._filter_by_type_name_ignore_case(this.handle, type.handle, obj)
    }

    GetCustomAttributes_1(inherit: boolean): NativePointer {
        return Il2cpp.Api.Module._GetCustomAttributes(this.handle, inherit)
    }

    GetCustomAttributes_2(type: mscorlib_System_Type_impl, inherit: boolean): NativePointer {
        return Il2cpp.Api.Module._GetCustomAttributes_1(this.handle, type.handle, inherit)
    }

    GetGuidInternal(): string {
        return readU16(Il2cpp.Api.Module._GetGuidInternal(this.handle))
    }

    GetHashCode(): number {
        return Il2cpp.Api.Module._GetHashCode(this.handle) as number
    }

    GetModuleVersionId(): mscorlib_System_Guid {
        return Il2cpp.Api.Module._GetModuleVersionId(this.handle)
    }
    ...
    GetObjectData(info: mscorlib_System_Runtime_Serialization_SerializationInfo_impl, context: mscorlib_System_Runtime_Serialization_StreamingContext): void {
        return Il2cpp.Api.Module._GetObjectData(this.handle, info, context)
    }

    IsDefined(type: mscorlib_System_Type_impl, inherit: boolean): boolean {
        return Il2cpp.Api.Module._IsDefined(this.handle, type.handle, inherit)
    }

    IsResource(): boolean {
        return Il2cpp.Api.Module._IsResource(this.handle)
    }

    op_Equality(other: mscorlib_System_Reflection_Module_impl): boolean {
        return Il2cpp.Api.Module._op_Equality(this.handle, other.handle)
    }

    ToString(): string {
        return readU16(Il2cpp.Api.Module._ToString(this.handle))
    }

    get_Assembly(): mscorlib_System_Reflection_Assembly_impl {
        return Il2cpp.Api.Module._get_Assembly(this.handle)
    }

    get_ModuleVersionId(): mscorlib_System_Guid {
        return Il2cpp.Api.Module._get_ModuleVersionId(this.handle)
    }

    get_ScopeName(): string {
        return readU16(Il2cpp.Api.Module._get_ScopeName(this.handle))
    }
}
...
Il2cpp.Module = mscorlib_System_Reflection_Module_impl;
