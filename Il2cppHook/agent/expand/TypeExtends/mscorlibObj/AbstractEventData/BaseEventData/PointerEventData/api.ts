...
class UnityEngine_EventSystems_PointerEventData_API {
    ...
    static get _set_pointerDrag() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_pointerDrag", 1, "void", ["pointer", "pointer"])
    }
    ...
    static get _get_eligibleForClick() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_eligibleForClick", 0, "pointer", ["pointer"])
    }

    // public Void set_eligibleForClick(Boolean value)
    @cache
    static get _set_eligibleForClick() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_eligibleForClick", 1, "void", ["pointer", "pointer"])
    }

    // public Int32 get_pointerId()
    @cache
    static get _get_pointerId() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_pointerId", 0, "pointer", ["pointer"])
    }

    // public Void set_pointerId(Int32 value)
    @cache
    static get _set_pointerId() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_pointerId", 1, "void", ["pointer", "pointer"])
    }
    ...
    static get _get_clickTime() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_clickTime", 0, "pointer", ["pointer"])
    }

    // public Void set_clickTime(Single value)
    @cache
    static get _set_clickTime() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_clickTime", 1, "void", ["pointer", "pointer"])
    }

    // public Int32 get_clickCount()
    @cache
    static get _get_clickCount() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_clickCount", 0, "pointer", ["pointer"])
    }

    // public Void set_clickCount(Int32 value)
    @cache
    static get _set_clickCount() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_clickCount", 1, "void", ["pointer", "pointer"])
    }
    ...
    static get _get_useDragThreshold() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_useDragThreshold", 0, "pointer", ["pointer"])
    }

    // public Void set_useDragThreshold(Boolean value)
    @cache
    static get _set_useDragThreshold() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_useDragThreshold", 1, "void", ["pointer", "pointer"])
    }

    // public Boolean get_dragging()
    @cache
    static get _get_dragging() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_dragging", 0, "pointer", ["pointer"])
    }

    // public Void set_dragging(Boolean value)
    @cache
    static get _set_dragging() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "set_dragging", 1, "void", ["pointer", "pointer"])
    }
    ...
    @cache
    static get __ctor() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", ".ctor", 1, "void", ["pointer", "pointer"])
    }

    // public Boolean IsPointerMoving()
    @cache
    static get _IsPointerMoving() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "IsPointerMoving", 0, "pointer", ["pointer"])
    }

    // public Boolean IsScrolling()
    @cache
    static get _IsScrolling() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "IsScrolling", 0, "pointer", ["pointer"])
    }

    // public Camera get_enterEventCamera()
    @cache
    static get _get_enterEventCamera() {
        return Il2Cpp.Api.t("UnityEngine.UI", "UnityEngine.EventSystems.PointerEventData", "get_enterEventCamera", 0, "pointer", ["pointer"])
    }
